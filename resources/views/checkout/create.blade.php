...
<main class="max-w-3xl mx-auto px-6 py-20">
    ...
    <div class="grid grid-cols-1 gap-8">
        ...
        <div class="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm">
            ...
            <div class="flex gap-6 items-start">
                ...
                <div>
                    ...
                    @if($event->price == 0)
                        <p class="text-indigo-600 font-bold mt-2">1 x Gratis</p>
                    @else
        ...
        <div class="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm">
            @auth
                <!-- SSO Google handling could auto-fill this -->
                <h3 class="text-xl font-bold mb-6 italic text-indigo-600 underline underline-offset-8">Data Pemesan (Login sebagai {{ Auth::user()->name }})</h3>
            @else
                <h3 class="text-xl font-bold mb-6 italic text-indigo-600 underline underline-offset-8">Data Pemesan (Tanpa Login)</h3>
                
                <!-- SSO Google Login Option -->
                <div class="mb-6">
                    <a href="{{ route('auth.google') }}" class="w-full flex items-center justify-center gap-3 py-3 bg-white border border-slate-300 rounded-2xl font-bold text-slate-700 hover:bg-slate-50 transition">
                    ...
                    <div class="mt-4 flex items-center justify-center space-x-4">
                        <div class="border-t border-slate-300 w-1/4"></div>
