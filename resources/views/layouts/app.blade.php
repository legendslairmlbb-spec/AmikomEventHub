...
<body class="bg-slate-50 text-slate-900">
    ...
    <nav
        ...
        <div class="hidden md:flex gap-8 font-medium">
            ...
            <a href="/?category=" class="hover:text-indigo-600 transition">Kategori</a>
            <a href="#" class="hover:text-indigo-600 transition">Tentang Kami</a>
        </div>
        <div class="flex gap-3">
            @auth
                <a href="{{ route('admin.dashboard') }}" class="px-5 py-2.5 bg-indigo-600 text-white rounded-xl font-semibold shadow-lg shadow-indigo-200 hover:bg-indigo-700 transition">Dashboard Admin</a>
            @else
                <a href="{{ route('admin.login') }}" class="px-5 py-2.5 rounded-xl font-semibold hover:bg-slate-200 transition">Login Admin</a>
            @endauth
        </div>
    </nav>
        ...
        <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div>
                ...
                <ul class="space-y-4">
                    ...
                    <li><a href="/?category=" class="hover:text-white transition">Semua Event</a></li>
